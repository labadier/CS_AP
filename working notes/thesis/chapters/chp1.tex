...
\subsection{Redes Neuronales Convolucionales en Grafos}
	...
	\begin{figure}[!thb]
		\centering
		\subfigure[Euclidian Structured Data]{\includegraphics[width=0.35\textwidth]{images/cnn-gnn.png}} \hspace{10mm}
		\subfigure[Non-Euclidian Structured Data]{\includegraphics[width=0.35\textwidth]{images/gnn-gnn.png}} 
