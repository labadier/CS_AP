...
\chapter{Framework}
	...
	El enfoque empleado para este trabajo se apoya en una arquitectura modular para modelar la información textual primeramente a nivel de tweets  y luego conformar una agregación de los mismos que sirva para describir y clasificar el perfil.
	...
	\subsection{Codificación basada en Transformers}
