...
hs=64
tmode=offline
python main.py -l EN -mode encoder -phase train -dp data/tasks/hater -ml 100 -tmode $tmode -bs 12  -epoches 1 -interm_layer $hs -lr 2e-5
...
# python main.py -l EN -mode fcnn -phase train -dp data/profiling/faker/train -interm_layer $hs -lr 3e-4 -epoches 80 -bs 32
