...
python main.py -l ES -mode CNN_LSTM_Encoder -phase train -dp data/profiling/faker/train -lr 2e-3 -epoch 12 -bs 64 -decay 0
python main.py -l EN -mode CNN_LSTM_Encoder -phase train -dp data/profiling/faker/train -lr 2e-3 -epoch 12 -bs 64 -decay 0
